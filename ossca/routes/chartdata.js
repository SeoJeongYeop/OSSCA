...
least(round(gs.repo_score_sub+gs.additional_score_sub,3), 5) as total_score_sub, 
least(round(gs.repo_score_sum+gs.additional_score_sum,3), 5) as total_score_sum
FROM github_score as gs JOIN student_tab as st ON gs.github_id = st.github_id where st.absence = 0`;
...
least(round(gs.repo_score_sub+gs.additional_score_sub,3), 5) as total_score_sub, 
least(round(gs.repo_score_sum+gs.additional_score_sum,3), 5) as total_score_sum
FROM github_score as gs JOIN student_tab as st ON gs.github_id = st.github_id where st.plural_major = 0`;
...
least(round(gs.repo_score_sub+gs.additional_score_sub,3), 5) as total_score_sub, 
least(round(gs.repo_score_sum+gs.additional_score_sum,3), 5) as total_score_sum
FROM github_score as gs JOIN student_tab as st ON gs.github_id = st.github_id where st.absence = 0 and st.plural_major = 0`;
